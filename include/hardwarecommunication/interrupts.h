...
namespace myos
{
    namespace hardwarecommunication
    {
        ...
        class InterruptManager
        {
            ...
            common::uint16_t hardwareOffset;
            ...
            InterruptManager(common::uint16_t hardwareOffset, myos::GlobalDescriptorTable* gdt, myos::TaskManager* taskManager);
            ~InterruptManager();
            ...
            common::uint8_t HardwareInterruptOffset();
