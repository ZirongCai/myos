    ...
    picSlaveData(0xA1)
{
    ...
    this->hardwareOffset = hardwareInterruptOffset;
    ...
    asm volatile("lidt %0" : : "m" (idt)); //load the base and limit into idtr(register)
}
...
void InterruptManager::Activate()
{
    ...
    asm("sti"); // enable all hardware interrupts
}
...
void InterruptManager::Deactivate()
{
    if(ActiveInterruptManager == this)
    {
        ...
        asm("cli");//disable all hardware interrupts
    }
}
...
uint8_t InterruptManager::HardwareInterruptOffset()
{
